...
const AddToCartBtn = ({
  ...
  const newClassName = twMerge(
    "bg-sea_blue uppercase text-xs py-3 text-center rounded-full font-semibold hover:bg-light_blue hover:text-white hover:scale-105 duration-200 cursor-pointer",
    className
  );
